...
<?php $component->withAttributes([]); ?>
    ...
    <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillrule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-
   2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" cliprule="evenodd"></path></svg>
    </div>
    <input name="start" type="text" class="bg-gray-50 border border-whitesmoke-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block wfull pl-10 p-2.5 dark:bg-white-smoke-700 dark:border-gray-600 dark:placeholder-gray-400 dark:textwhite dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date start">
    </div>
   ...
   <input name="end" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block wfull pl-10 p-2.5 dark:bg-white-smoke-700 dark:border-gray-600 dark:placeholder-gray-400 dark:textwhite dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date end">
    </div>
   </div>
   <button type="button" class="inline-block mx-4 px-6 py-2 border-2 border-blue-600 text-blue-600 font-medium text-xs leading-tight uppercase rounded-r-md hover:bg-indigo-100 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration150 ease-in-out">Check</button>
    </div>
    </div>
    <section>
    <div class="md:flex font-sans pt-8">
    <div class="md:shrink-0">
    <img src="https://i1.wp.com/helloindonesia.id/wp-content/uploads/2018/12/Tari-Kecak-Ulu-Watu_edited.jpg" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
    </div>
   <form class="p-6">
   ...
   <div class="md:flex font-sans pt-8">
    <div class="md:shrink-0">
    <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0d/a2/e5/a7/kecak-dance-pura-dalem.jpg?w=1000&h=-1&s=1" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull h-full object-cover rounded-lg" loading="lazy" />
    </div>
   <form class="p-6">
    <div class="flex flex-wrap">
    <h1 class="flex-auto font-medium text-slate-900">
...
<?php endif; ?>
   <?php /**PATH D:\Kuliah\Prodi\smster 3\TEKWEB\Latihan WEB\bookingonline\resources\views/frontpage/landingpage.blade.php ENDPATH**/ ?>